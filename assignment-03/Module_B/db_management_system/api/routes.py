...
def create_token_fixture():
    ...
    try:
        ...
        session_id = _next_integer_id(conn, "UploadSession", "sessionID")
        token_id = _next_integer_id(conn, "OneTimeToken", "tokenID")
...
def consume_one_time_token():
    ...
    if simulate_failure and not failure_stage:
        # Backward compatible behavior for existing tests/callers.
    ...
    try:
        ...
        download_id = _next_integer_id(conn, "DownloadLog", "downloadID")
        conn.execute(
            """
